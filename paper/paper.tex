...
\begin{table*}
	...
	\begin{center}
		\begin{tabular}{l|ccc|ccc}
			...
			Simple dummy BL 		& 0.13 & 0.24 & 0.14 & 0.13 & 0.24 & 0.13 \\
			\midrule
...
\begin{table*}
	...
	\begin{center}
		\begin{tabular}{l|ccc|ccc}
			...
			\cmidrule{2-7}
			& $R_{\mathrm{B}^3}$ & $P_{\mathrm{B}^3}$ & $F_\mathrm{\mathrm{B}^3}$ & $R_{\mathrm{B}^3}$ & $P_{\mathrm{B}^3}$ & $F_\mathrm{\mathrm{B}^3}$ \\
			\midrule
			Single-author dummy BL 		& 0.33 & 1.00 & 0.47 & 0.37 & 1.00 & 0.52 \\
			Stochastic dummy BL 		& 0.35 & 0.59 & 0.41 & 0.39 & 0.59 & 0.45 \\
			Simple dummy BL 			& 0.43 & 0.50 & 0.45 & 0.45 & 0.54 & 0.45 \\
			\midrule
			\citet{kuznetsov-2016}		& 0.46 & 0.64 & 0.52 & 0.42 & 0.64 & 0.48 \\
			\citet{sittar-2016} 		& 0.47 & 0.28 & 0.32 & 0.47 & 0.31 & 0.35 \\
			\midrule			
			Model A 					&  &  &  &  &  & \\			
